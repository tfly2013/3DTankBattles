...
namespace Project2
{
    ...
    {
        public Shield(Project2Game game, float posX, float posZ, float yaw)
            : base(game, posX, posZ)
        {
            model = game.Content.Load<Model>("items/shield/shield");
            texture = game.Content.Load<Texture2D>("items/shield/Map");
